...
double **Mat_1(double **M,double a,double angle);
double **Mat_2(double **N,double a,double angle);
//End function declaration

double Matdiv(double **a, double **b){
	return a[0][0]/b[0][0];
}
...
double **Mat_1(double **M,double a,double angle)
{
	double **P = Matadd(M, np_array(a*-cos(angle),a*sin(angle)),2,1);
	return P;
}

double **Mat_2(double **N,double a,double angle)
{
	double **Q = Matadd(N, np_array(a*cos(angle),a*sin(angle)),2,1);
	return Q;
}
