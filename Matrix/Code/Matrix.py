...
sys.path.insert(0, '/sdcard/FWC-2/Assignments/geometry/Triangle/Matrices/codes/CoordGeo')        #path to my scripts
import numpy as np
import math
...
df= pd.read_excel('/sdcard/FWC-2/Assignments/geometry/Triangle/Matrices/tables/vertices.xlsx')
print(df)
...
plt.show()
#if using termux
plt.savefig('/sdcard/FWC-2/Assignments/geometry/Triangle/Matrices/figs/D3E3F3.png')
